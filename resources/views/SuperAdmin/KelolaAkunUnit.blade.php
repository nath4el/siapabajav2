...
<style>
  ...
  .dash-nav::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.3); border-radius: 10px; }
  ...
  .modal-head h2 { margin: 0; font-size: 20px; color: #1f5872; font-weight: 700; }
  .modal-close { border: 0; background: transparent; color: #1f5872; font-size: 24px; cursor: pointer; padding: 0; }
  .modal-divider { height: 1px; background: #e5e7eb; margin: 18px 0 22px; }
  ...
  .select-wrap i { position: absolute; right: 16px; top: 50%; transform: translateY(-50%); color: #1f5872; pointer-events: none; font-size: 18px; }
