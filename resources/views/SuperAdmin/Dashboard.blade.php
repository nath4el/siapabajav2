...
<div class="dash-wrap">
  <aside class="dash-sidebar">
    ...
    <nav class="dash-nav">
      <a class="dash-link active" href="{{ route('superadmin.dashboard') }}">
  ...
  <div class="u-top">
    <div>
      ...
      <div class="u-value u-value--navy js-count" id="valPaket" data-count="...">0</div>
        ...
        <div class="u-card">
          ...
          <div class="u-top">
            <div>
              ...
              <div class="u-money js-count" id="valNilai" data-count="{{ (int) preg_replace('/[^0-9]/','', (string) $summary[6]['value']) }}">Rp 0</div>
    ...
    <section class="u-charts">
      <div class="u-chart-card">
        <div class="u-chart-head">
          <div class="u-chart-title">Statistika</div>
...
.dash-header {
    width: 100%;
    display: flex;
    flex-direction: column; /* ⬅️ biar h1 & p turun ke bawah */
    gap: 4px;
}
